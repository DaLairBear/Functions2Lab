...
// CODE HERE
uniq(names, uniquArr => console.log(`The new names array with all the duplicate items removed is ${noDuplicates}`))
...
// CODE HERE
each(names, print = (name, index) => console.log(`The item at index ${index} is ${name}`))
